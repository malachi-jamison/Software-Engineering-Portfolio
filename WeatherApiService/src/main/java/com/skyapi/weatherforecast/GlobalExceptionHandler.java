...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ResponseBody
	public ErrorDTO handleGeolocationBadRequestException(HttpServletRequest request, Exception ex) {
		ErrorDTO error = new ErrorDTO();
	...
	public ErrorDTO handleConstraintViolationException(HttpServletRequest request, Exception ex) {
		...
		//From video, was printing errors out of order
...
//		});
		...
		//AI
		var constraintViolations = new ArrayList<>(violationException.getConstraintViolations());
		constraintViolations.sort(Comparator.comparing(violation -> violation.getPropertyPath().toString()));
