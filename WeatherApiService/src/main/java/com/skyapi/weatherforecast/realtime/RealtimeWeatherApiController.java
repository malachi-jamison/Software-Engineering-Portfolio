...
public class RealtimeWeatherApiController {
	...
	public ResponseEntity<?> updateRealtimeWeatherByLocationCode(@PathVariable String locationCode,
		...
		RealtimeWeatherDTO updatedDto = entity2DTO(updateRealtimeWeather);
